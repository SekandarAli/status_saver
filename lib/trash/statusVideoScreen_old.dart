...
//     super.initState();
//     fileController.allStatusVideos.forEach((element) {
//       getVideo(element.filePath);
//     });
//   }
//   Future pullRefresh() async {
//     setState(() {});
...
//       backgroundColor: ColorsTheme.backgroundColor,
//       body: FutureBuilder(
//           future: getVideo(fileController.allStatusVideos.elementAt(3).filePath),
//           builder: (context, snapshot) {
//             if (snapshot.connectionState == ConnectionState.done) {
//               log("done2");
//               if (fileController.allStatusVideos.isNotEmpty) {
...
//                                     : ColorsTheme.doneColor,
//                                 icon: fileController.allStatusVideos.elementAt(index).isSaved == false
//                                     ? Icons.save_alt
//                                     : Icons.done,
//                                 color: fileController.allStatusVideos.elementAt(index).isSaved ==
//                                     false
//                                     ? ColorsTheme.white
//                                     : ColorsTheme.doneColor,
//                                 onSharePress: () {
...
//             } else {
//               return Hero(
//                 tag: fileController.allStatusVideos.elementAt(0).filePath.replaceAll("%20", " "),
//                 // child: Image.asset(Assets.imagesLoadingAnimation,width: 5,height: 5),
//                 child: ReusingWidgets.loadingAnimation(),
//               );
//             }
